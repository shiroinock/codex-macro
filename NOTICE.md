...
QMK Firmware is separately licensed under the GNU General Public License version 2. Consult its repository for its license and copyright notices. No QMK source code is included in this repository.
